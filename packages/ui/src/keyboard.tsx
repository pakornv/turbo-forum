...
const keyboardStyles = tv({
  slots: {
    base: "hidden text-current/70 group-data-disabled:opacity-50 group-data-focused:text-fg group-data-focused:opacity-90 group-data-hovered:text-fg lg:inline-flex forced-colors:group-data-focused:text-[HighlightText]",
